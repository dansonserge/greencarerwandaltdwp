...
if (class_exists('WP_Customize_Control')) {
	...
	class themesflat_Typography extends WP_Customize_Control {
		...
		public function render_content() {
			$this->titles = array(
				'100'        => esc_html__( 'Thin 100', 'graingrow' ),
				'100italic'  => esc_html__( 'Thin 100 italic', 'graingrow' ),
				'200'        => esc_html__( 'Extra-light 200', 'graingrow' ),
				'200italic'  => esc_html__( 'Extra-light 200 italic', 'graingrow' ),
				'300'        => esc_html__( 'Light 300', 'graingrow' ),
				'300italic'  => esc_html__( 'Light 300 italic', 'graingrow' ),
				'400'        => esc_html__( 'Normal 400', 'graingrow' ),
				'400italic'  => esc_html__( 'Normal 400 italic', 'graingrow' ),
				'regular'    => esc_html__( 'Normal 400', 'graingrow' ),
				'italic'     => esc_html__( 'Normal 400 italic', 'graingrow' ),
				'500'        => esc_html__( 'Medium 500', 'graingrow' ),
				'500italic'  => esc_html__( 'Medium 500 italic', 'graingrow' ),
				'600'        => esc_html__( 'Semi-bold 600', 'graingrow' ),
				'600italic'  => esc_html__( 'Semi-bold 600 italic', 'graingrow' ),
				'700'        => esc_html__( 'Bold 700', 'graingrow' ),
				'700italic'  => esc_html__( 'Bold 700 italic', 'graingrow' ),
				'800'        => esc_html__( 'Extra-bold 800', 'graingrow' ),
				'800italic'  => esc_html__( 'Extra-bold 800 italic', 'graingrow' ),
				'900'        => esc_html__( 'Ultra-bold 900', 'graingrow' ),
				'900itallic' => esc_html__( 'Ultra-bold 900 italic', 'graingrow' )
			);

			$this->titles_subsets = array(
				"cyrillic-ext"  => esc_html__("Cyrillic Extended",'graingrow'),
			    "greek" 		=> esc_html__("Greek",'graingrow'),
			    "greek-ext"		=>	esc_html__("Greek Extended",'graingrow'),
			    "latin-ext"		=>	esc_html__("Latin Extended",'graingrow'),
			    "cyrillic"		=>	esc_html__("Cyrillic",'graingrow'),
			    "vietnamese"	=>	esc_html__("Vietnamese",'graingrow'),
			    "latin" 		=> esc_html__("Latin",'graingrow')
				);
			...
			<div class="themesflat-options-control-inputs">					
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-font">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-family"><?php esc_html_e( 'Font Family', 'graingrow' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<select name="<?php  echo esc_attr( $name ) ?>[family]" id="<?php  echo esc_attr( $name ) ?>-family" class="select-choosen" >
							<optgroup label="<?php echo esc_html( 'Google Fonts', 'graingrow' ) ?>">
				...
				<div class="themesflat-options-control-chosen themesflat-typography-group typography-style">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Weight & Style', 'graingrow' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
						<label>
				...
				<?php if ( in_array( 'subsets', $this->fields ) ): ?>
					<div class="themesflat-options-control typography-subsets themesflat-options-control-switcher active">
						<div class="themesflat-options-control-title customize-control-title">
							<label><?php esc_html_e( 'Font subsets', 'graingrow' ) ?></label>
						</div>
						<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-size">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-size"><?php esc_html_e( 'Font Size (px)', 'graingrow' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-line_height">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-line_height"><?php esc_html_e( 'Line height ( ex: 25px or 1.8 or 150% )', 'graingrow' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group typography-letter_spacing">
					<div class="themesflat-options-control-title customize-control-title">
						<label for="<?php  echo esc_attr( $name ) ?>-letter_spacing"><?php esc_html_e( 'Letter Spacing ( Value in px or em )', 'graingrow' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
				...
				<div class="themesflat-typography-group themesflat-options-control-color-picker typography-color">
					<div class="themesflat-options-control-title customize-control-title">
						<label><?php esc_html_e( 'Font Color', 'graingrow' ) ?></label>
					</div>
					<div class="themesflat-options-control-inputs">
