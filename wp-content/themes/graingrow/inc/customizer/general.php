...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Smooth Scroll ( OFF | ON )', 'graingrow'),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Preload ( OFF | ON )', 'graingrow'),
        'section' => 'general_panel',
        'priority' => 2,
    ))
);
...
$wp_customize->add_control( new themesflat_RadioImages($wp_customize,
    ...
    array (
        ...
        'section'   => 'general_panel',
        'priority'  => 3,
        'label'         => esc_html__('Preload', 'graingrow'),
        'choices'   => array (
            'preload-1' => array (
                'tooltip'   => esc_html__( 'Circle Loaders 1','graingrow' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-1.png'
            ) ,
            'preload-2'=>  array (
                'tooltip'   => esc_html__( 'Circle Loaders 2','graingrow' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-2.png'
            ) ,
            'preload-3'=>  array (
                'tooltip'   => esc_html__( 'Circle Loaders 3','graingrow' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-3.png'
            ) ,
            'preload-4'=>  array (
                'tooltip'   => esc_html__( 'Circle Loaders 4','graingrow' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-4.png'
            ) ,
            'preload-5'=>  array (
                'tooltip'   => esc_html__( 'Spinner Loaders','graingrow' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-5.png'
            ) ,
            'preload-6'=>  array (
                'tooltip'   => esc_html__( 'Pulse Loaders','graingrow' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-6.png'
            ) ,
            'preload-7'=>  array (
                'tooltip'   => esc_html__( 'Square Loaders','graingrow' ),
                'src'       => THEMESFLAT_LINK . 'images/controls/preload-7.png'
            ) ,
            'preload-8'=>  array (
                'tooltip'   => esc_html__( 'Line Loaders','graingrow' ),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Social Share  ( OFF | ON )', 'graingrow'),
        'description'   => esc_html__('Social share only visible on detail pages', 'graingrow'),
        'section' => 'general_panel',
        'priority' => 6,
    ))
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Go To Button ( OFF | ON )', 'graingrow'),
        'section' => 'general_panel',
        'priority' => 8,
    ))
);
