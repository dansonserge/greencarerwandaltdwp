    ...
    array (
        ...
        'choices'   => array (
            'header-default' => array (
                'tooltip'   => esc_html__( 'Header Default','graingrow' ),
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Header Absolute ( OFF | ON )', 'graingrow'),
        'section' => 'section_options',
        'priority' => 1,
    ))
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Header Sticky ( OFF | ON )', 'graingrow'),
        'section' => 'section_options',
        'priority' => 2,
    ))
);    
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Search Box ( OFF | ON )', 'graingrow'),
        'section' => 'section_options',
        'priority' => 5,
    ))
);
...
$wp_customize->add_control( new themesflat_Checkbox( $wp_customize,
    ...
    array(
        'type' => 'checkbox',
        'label' => esc_html__('Sidebar Toggler ( OFF | ON )', 'graingrow'),
        'section' => 'section_options',
        'priority' => 5,
    ))
);
...
//     array(
//         'type' => 'checkbox',
//         'label' => esc_html__('Header Cart ( OFF | ON )', 'graingrow'),
//         'section' => 'section_options',
//         'priority' => 6,
//     ))
// );
