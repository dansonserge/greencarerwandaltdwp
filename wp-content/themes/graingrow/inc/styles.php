...
function themesflat_custom_styles( $custom ) {
	...
	//GROUP FONT
		...
		/*Typography blog post buttons*/	
		    ...
		    if ( $blog_post_buttons_letter_spacing != '' ) {
		        $custom .= "article .themesflat-btn-blog { letter-spacing:" . $blog_post_buttons_letter_spacing . ";}"."\n";
		    }
		...
		/*Typography footer widget title*/	
			...
			// font family
			if ( $footer_widget_title_fonts_family != '') {
				$custom .= "footer .footer-widgets .widget.widget_text, footer .widget.widget_nav_menu ul li a { font-family:" . $footer_widget_title_fonts_family . ";}"."\n";
			}
			// font weight
			if ( $footer_widget_title_font_weight != '' ) {
				$custom .= "footer .footer-widgets .widget.widget_text, footer .widget.widget_nav_menu ul li a { font-weight:" . $footer_widget_title_font_weight . ";}"."\n";
			}
			// font style
			if ( isset( $footer_widget_title_font_style )) {
				$custom .= "footer .footer-widgets .widget.widget_text, footer .widget.widget_nav_menu ul li a { font-style:" . $footer_widget_title_font_style . "; }"."\n";  
			}
			// font size
			if ( $footer_widget_title_fonts_size != '' ) {
				$custom .= "footer .footer-widgets .widget.widget_text, footer .widget.widget_nav_menu ul li a { font-size:" . intval($footer_widget_title_fonts_size) . "px;}"."\n";
			}
			// line height
			if ( $footer_widget_title_line_height != '' ) {
				$custom .= "footer .footer-widgets .widget.widget_text, footer .widget.widget_nav_menu ul li a { line-height:" . $footer_widget_title_line_height . ";}"."\n";
			} 
			// letter spacing
			if ( $footer_widget_title_letter_spacing != '' ) {
				$custom .= "footer .footer-widgets .widget.widget_text, footer .widget.widget_nav_menu ul li a { letter-spacing:" . $footer_widget_title_letter_spacing . ";}"."\n";
			}
		...
		/*Typography buttons*/	
			...
			/*Typography buttons loadmore*/	
		    $buttons_lm_fonts_ = themesflat_get_json('typography_buttons_loadmore');
			$buttons_lm_fonts_family = $buttons_lm_fonts_['family'];
			$buttons_lm_fonts_size = $buttons_lm_fonts_['size'];
			$buttons_lm_line_height = $buttons_lm_fonts_['line_height'];
			$buttons_lm_letter_spacing = $buttons_lm_fonts_['letter_spacing'];
			$buttons_lm_style = themesflat_font_style( $buttons_lm_fonts_['style'] );
			$buttons_lm_font_weight = $buttons_lm_style[0];
			$buttons_lm_font_style = $buttons_lm_style[1]; 
			// font family
			if ( $buttons_lm_fonts_family != '') {
				$custom .= ".navigation.loadmore a { font-family:" . $buttons_lm_fonts_family . ";}"."\n";
			}
			// font weight
			if ( $buttons_lm_font_weight != '' ) {
				$custom .= ".navigation.loadmore a { font-weight:" . $buttons_lm_font_weight . ";}"."\n";
			}
			// font style
			if ( isset( $buttons_lm_font_style )) {
		        $custom .= ".navigation.loadmore a { font-style:" . $buttons_lm_font_style . "; }"."\n";  
			}
		    // font size
		    if ( $buttons_lm_fonts_size != '' ) {
		        $custom .= ".navigation.loadmore a { font-size:" . intval($buttons_lm_fonts_size) . "px;}"."\n";
		    }
		    // line height
		    if ( $buttons_lm_line_height != '' ) {
		        $custom .= ".navigation.loadmore a { line-height:" . $buttons_lm_line_height . ";}"."\n";
		    } 
		    // letter spacing
		    if ( $buttons_lm_letter_spacing != '' ) {
		        $custom .= ".navigation.loadmore a { letter-spacing:" . $buttons_lm_letter_spacing . ";}"."\n";
		    }
		...
		/*Typography pagination*/	
			...
			if ( $pagination_fonts_family != '') {
				$custom .= ".navigation a, .pagination > span, .navigation.paging-navigation span, .page-links a, .page-links > span, .woocommerce-pagination ul li span, .woocommerce-pagination ul li a { font-family:" . $pagination_fonts_family . ";}"."\n";
			}
			// font weight
			if ( $pagination_font_weight != '' ) {
				$custom .= ".navigation a, .pagination > span, .navigation.paging-navigation span, .page-links a, .page-links > span, .woocommerce-pagination ul li span, .woocommerce-pagination ul li a { font-weight:" . $pagination_font_weight . ";}"."\n";
			}
			// font style
			if ( isset( $pagination_font_style )) {
		        $custom .= ".navigation a, .pagination > span, .navigation.paging-navigation span, .page-links a, .page-links > span, .woocommerce-pagination ul li span, .woocommerce-pagination ul li a { font-style:" . $pagination_font_style . "; }"."\n";  
			}
		    // font size
		    if ( $pagination_fonts_size != '' ) {
		        $custom .= ".navigation a, .pagination > span, .navigation.paging-navigation span, .page-links a, .page-links > span, .woocommerce-pagination ul li span, .woocommerce-pagination ul li a { font-size:" . intval($pagination_fonts_size) . "px;}"."\n";
		    }
		    // line height
		    if ( $pagination_line_height != '' ) {
		        $custom .= ".navigation a, .pagination > span, .navigation.paging-navigation span, .page-links a, .page-links > span, .woocommerce-pagination ul li span, .woocommerce-pagination ul li a { line-height:" . $pagination_line_height . ";}"."\n";
		    } 
		    // letter spacing
		    if ( $pagination_letter_spacing != '' ) {
		        $custom .= ".navigation a, .pagination > span, .navigation.paging-navigation span, .page-links a, .page-links > span, .woocommerce-pagination ul li span, .woocommerce-pagination ul li a { letter-spacing:" . $pagination_letter_spacing . ";}"."\n";
		    }
	...
	//GROUP TOP BAR 
	    ...
	    if ( themesflat_get_opt( 'topbar_link_color_hover' ) !='' ) {
			$custom .= ".themesflat-top a:hover, .themesflat-top .themesflat-socials a:hover { color:" . esc_attr( themesflat_get_opt( 'topbar_link_color_hover' ) ) ." ;} "."\n";
	    }
	...
	//GROUP HEADER
		...
		if ( $header_backgroundcolor !='' ) {
			$custom .= "#header.header-default, #header.header-style1, #header.header-style2, #header.header-style4, #header.header-style3 .header-ct-center, #header.header-style3 .header-ct-right, #header.header-style3:before { background:" . esc_attr($header_backgroundcolor) . ";}"."\n";
		}
		...
		if ( $mainnav_hover_color !='' ) {
			$custom .= "#mainnav > ul > li > a:hover { color:" . esc_attr($mainnav_hover_color) . ";}"."\n";
		}
	...
	//GROUP FOOTER
		...
		if ( $footer_text_color !='' ) {
			$custom .= "#footer, #footer a, footer .widget.widget-recent-news li .text .post-date,  #footer .footer-widgets .widget.widget_themesflat_socials ul li a, footer select option, footer .widget.widget_recent_entries ul li .post-date, #footer .wp-block-latest-posts__post-author, #footer .wp-block-latest-posts__post-date { color:" . esc_attr($footer_text_color) . ";}"."\n";
		}
		if ( $footer_text_color !='' ) {
	...
	//GROUP ACTION BOX
	    ...
	    if ( $action_box_background_image !='' ) {
		    $custom .= '.themesflat-action-box {background-image: url('.$action_box_background_image.');}'."\n";  
		}		
		...
		if ( $action_box_heading_color !='' ) {
			$custom .= ".themesflat-action-box .heading, .themesflat-action-box h2, .themesflat-action-box h3, .themesflat-action-box h5, .themesflat-action-box h6 { color:" . esc_attr($action_box_heading_color) . ";}"."\n";
		}
		// Action Box Text Color
		$action_box_text_color = themesflat_get_opt( 'action_box_text_color');
		if ( $action_box_text_color !='' ) {
			$custom .= ".themesflat-action-box, .themesflat-action-box h4 { color:" . esc_attr($action_box_text_color) . ";}"."\n";
		}
		...
		if ( $action_box_button_text_color !='' ) {
			$custom .= ".themesflat-action-box .themesflat-button, .themesflat-action-box .themesflat-button:hover { color:" . esc_attr($action_box_button_text_color) . ";}"."\n";
		}
		...
		if ( $action_box_button_background_color !='' ) {
			$custom .= ".themesflat-action-box .themesflat-button { background-color:" . esc_attr($action_box_button_background_color) . ";}"."\n";			
		}
	...
	//GROUP BODY
		...
		// button loadmore color
		$bottom_background_color_loadmore = themesflat_get_opt( 'bottom_background_color_loadmore');
		if ( $bottom_background_color_loadmore !='' ) {
			$custom .= ".navigation.loadmore.paging-navigation a { color:" . esc_attr($bottom_background_color_loadmore) . ";}"."\n";
		}
		$bottom_background_color_loadmore_hover = themesflat_get_opt( 'bottom_background_color_loadmore_hover');
		if ( $bottom_background_color_loadmore_hover !='' ) {
			$custom .= ".navigation.loadmore.paging-navigation a:hover { color:" . esc_attr($bottom_background_color_loadmore_hover) . ";}"."\n";
		}
		$bottom_background_color_loadmore_bg = themesflat_get_opt( 'bottom_background_color_loadmore_bg');
		if ( $bottom_background_color_loadmore_bg !='' ) {
			$custom .= ".navigation.loadmore.paging-navigation a { background:" . esc_attr($bottom_background_color_loadmore_bg) . ";border-color:" . esc_attr($bottom_background_color_loadmore_bg) . ";}"."\n";
		}
		$bottom_background_color_loadmore_bg_hover = themesflat_get_opt( 'bottom_background_color_loadmore_bg_hover');
		if ( $bottom_background_color_loadmore_bg_hover !='' ) {
			$custom .= ".navigation.loadmore.paging-navigation a:hover { background:" . esc_attr($bottom_background_color_loadmore_bg_hover) . ";border-color:" . esc_attr($bottom_background_color_loadmore_bg_hover) . ";}"."\n";
		}
	...
	//GROUP COLOR
	    ...
	    if ( $primary_color !='' ) { 
	    	...
	    	$custom .= "a,article .entry-title a, .item article .entry-title a, .widget.widget_categories ul li a, .widget.widget_archive ul li a, .widget.widget_pages ul li a, .widget.widget_block .wp-block-archives li a, .widget.widget_block .wp-block-categories li a, article .post-meta .item-meta a, .tags-links a, .logged-in-as a, blockquote em a,blockquote em { color:" . esc_attr($primary_color) . ";}"."\n";

	    	//Sidebar
	    	$custom .= ".sidebar .widget ul li a { color:" . esc_attr($primary_color) . ";}"."\n";

	    	$custom .= ".comment-list .comement_reply a, .sidebar .widget_recent_comments ul li, .sidebar .widget.widget_block ol.wp-block-latest-comments li, .sidebar .widget.widget_recent_comments ul li, .sidebar .widget.widget_rss ul li, .sidebar .widget.widget_block ol.wp-block-latest-comments li, .sidebar .wp-block-search .wp-block-search__label, .sidebar .wc-block-product-search .wc-block-product-search__label { color:" . esc_attr($primary_color) . ";}"."\n";

	    	$custom .= ".tf-posts .blog-post .tf-button:hover, .tf-posts .blog-post .title a { color:" . esc_attr($primary_color) . ";}"."\n";

	    	$custom .= "#commentform .wrap-input-submit:before, .themesflat-button:before, .wp-block-button__link:before, .draw-border a:before, .block-get-a-quote a:before, button:before, .btn:before, input[type=\"button\"]:hover, input[type=\"reset\"]:hover, input[type=\"submit\"]:hover, .search-form .search-submit:hover, .wishlist_table .product-add-to-cart a:before, .widget_shopping_cart_content .buttons>a:before, .widget_shopping_cart_content .buttons a.checkout:before { background-color:" . esc_attr($primary_color) . ";}"."\n";
    	...
    	if ( $secondary_color !='' ) {
    		...
    		$custom .= '.navigation.paging-navigation a:hover,  .navigation.paging-navigation .current, .navigation.paging-navigation a.next:hover, .navigation.paging-navigation a.prev:hover   { background-color:' . esc_attr($secondary_color) . " }"."\n";
    	...
    	if ( $accent_color !='' ) {
    		$custom .= 'a:hover,  .flat-language ul.unstyled-child li a:hover { color:' . esc_attr($accent_color) . " }"."\n";
    		$custom .= '#mainnav ul.sub-menu > li > a > span, #mainnav_canvas ul li a > span   { background-color:' . esc_attr($accent_color) . " }"."\n";
    		
    		$custom .= ' :root { --theme-accent-color:' . esc_attr($accent_color) . " }"."\n";


			//color
			$custom .= ".comment-list .comement_reply a:hover,  blockquote em a:hover, blockquote i,blockquote cite a, article .entry-title a:hover, .navigation.posts-navigation .nav-links a:hover, .widget_calendar table #today:hover, .widget_calendar table #today a:hover, .widget_calendar table tbody tr a:hover, .widget_calendar nav a:hover, article .post-meta .item-meta:hover .meta-icon, article .post-meta .item-meta a:hover, .social-share-article ul li a:hover, .widget.widget-recent-news li .text .post-date i, .widget.widget_latest_news li .text .post-date i, .widget.widget-recent-news li .text h6 a:hover, .widget.widget_latest_news li .text h6 a:hover,.portfolios-post .content .post-meta a:hover, .portfolios-post .content .title a:hover, blockquote a:hover, .widget.widget_recent_entries ul li a:hover, .widget.widget_block ul.wp-block-latest-posts li a:hover, #mainnav_canvas ul li.current-menu-item > a, #mainnav_canvas ul li.current_page_item > a, #mainnav_canvas ul li.current-menu-ancestor > a, #mainnav_canvas ul li.current-menu-parent > a, .tags-links a:hover, .logged-in-as a:hover, .comments-area ol.comment-list article .comment_content .comment_meta .comment_author a:hover, .single-portfolios .entry-content .meta-post a:hover, .single-project .entry-content .meta-post a:hover, .services-post .title a:hover, .services-post .tf-button-container a:hover, .info-header .phone:hover, .post-meta a:hover, #mainnav_canvas ul li a:hover, article .entry-title a:hover, .item article .entry-title a:hover, .widget ul li a:hover, .widget ol li a:hover, .sidebar .widget.widget_nav_menu ul li a:hover, .widget.widget_meta ul li a:hover{ color:" . esc_attr($accent_color) . ";}"."\n";


			//sidebar
			$custom .= ".sidebar .widget ul li a:hover { color:" . esc_attr($accent_color) . ";}"."\n";

			$custom .= " input[type=\"button\"]:hover, input[type=\"reset\"]:hover, input[type=\"submit\"]:hover, mark, ins, .go-top:hover, #commentform .wrap-input-submit, .draw-border a, .widget.widget_archive ul li a:hover, .widget.widget_categories ul li a:hover, .widget.widget_pages ul li a:hover,input[type=\"button\"], input[type=\"reset\"], input[type=\"submit\"], .wp-block-button__link, .wp-block-file .wp-block-file__button, .page-links a:hover, .page-links a:focus, .page-links > span, input[type='radio']:checked:before, .block-get-a-quote .overlay-color, .themesflat-top .btn-topbar { background:" . esc_attr($accent_color) . ";}"."\n";

			$custom .= "textarea:focus, input[type=\"text\"]:focus, input[type=\"password\"]:focus, input[type=\"datetime\"]:focus, input[type=\"datetime-local\"]:focus, input[type=\"date\"]:focus, input[type=\"month\"]:focus, input[type=\"time\"]:focus, input[type=\"week\"]:focus, input[type=\"number\"]:focus, input[type=\"email\"]:focus, input[type=\"url\"]:focus, input[type=\"search\"]:focus, input[type=\"tel\"]:focus, input[type=\"color\"]:focus, .widget.widget_archive ul li a:hover, .widget.widget_categories ul li a:hover, .widget.widget_pages ul li a:hover, .sidebar .wpcf7-form textarea:focus, .single-portfolios .entry-content .meta-post .inner-meta-post, .single-project .entry-content .meta-post .inner-meta-post, .is-style-outline>.wp-block-button__link, .wp-block-button__link.is-style-outline, input[type='radio']:checked { border-color:" . esc_attr($accent_color) . ";}"."\n";
			
			$custom .= ".draw-border.second-color a:hover, .draw-border.second-color button:hover,  .wishlist_table span.wishlist-in-stock, #footer .widget_calendar nav a:hover, #footer .widget_calendar table tbody tr a:hover { color:" . esc_attr($accent_color) . "!important;}"."\n";
			$custom .= "select:focus, .draw-border.second-color a:hover::before, .draw-border.second-color a:hover::after, .draw-border.second-color button:hover > span::before, .draw-border.second-color button:hover > span::after, .widget_search form input[type=\"search\"]:focus, .wp-block-search .wp-block-search__input:focus, .footer .mc4wp-form input[type=\"email\"]:focus { border-color:" . esc_attr($accent_color) . " !important;}"."\n";

			$custom .= ".double-bounce3, .double-bounce4, .widget .widget-title:after, .widget .tagcloud a:hover, .go-top:hover, .search-form .search-submit, .btn-menu:before, .btn-menu:after, .btn-menu span, .info-footer .wrap-info-item, .single-portfolios .entry-footer .social-share-article a:hover, .portfolios-post .content .tf-button:hover, .single-project .entry-footer .social-share-article a:hover, .project-post .content .tf-button:hover { background: ". esc_attr($accent_color) .";}"."\n";
			//svg
			$custom .= ".info-header .icon-info svg, .themesflat-services-taxonomy .services-post .post-icon svg, .tf-services-wrap.style2 .services-post:hover .post-icon svg { fill:" . esc_attr($accent_color) . "}"."\n";

			//color shop
			$custom .= ".woo-single-post-class .woocommerce-product-details__short-description li:before, .widget_shopping_cart_content ul li a.remove, .widget_shopping_cart_content .total span.woocommerce-Price-amount, .wc-block-grid__product.wc-block-grid__product .wc-block-grid__product-link:hover, .woocommerce .shop_table.order_details tr td .woocommerce-Price-amount, .woocommerce .shop_table.order_details th a:hover, .woocommerce .shop_table.order_details tr td.woocommerce-table__product-name a:hover, .woocommerce-page .shop_table.cart .product-name a:hover, .woo-single-post-class .summary a:hover { color:" . esc_attr($accent_color) . "!important;}"."\n";
			$custom .= ".woocommerce-page .cart_totals .shop_table .order-total td, .widget_product_categories ul li a:hover, .wc-block-product-categories ul li a:hover { color:" . esc_attr($accent_color) . " !important;}"."\n";
			$custom .= ".woocommerce-page .woo-single-post-class .summary .stock.in-stock, .product .onsale, .woocommerce-pagination ul li span.current, .woocommerce-pagination ul li a:hover, .woocommerce-page .wc-proceed-to-checkout .button, .sidebar .widget.woocommerce .widget-title:before, .sidebar .widget.woocommerce .widget-title:after, .header-cart-wrapper .shopping-cart-items-count, .tf-team .inner-image:before, .widget_shopping_cart_content .buttons>a, .widget_shopping_cart_content .buttons a.checkout, .woocommerce-page .shop_table.cart .product-remove a:hover, .widget_shopping_cart_content ul li a.remove:hover, .header-cart-wrapper .nav-cart-trigger, .header-wishlist-wrapper .nav-wishlist-trigger, .products li .wrap-btn-action .loading:after, .wc-block-grid__product-onsale, .products li .wrap-btn-action .yith-wcwl-add-to-wishlist, .products li .wrap-btn-action .button, .products li .product-info .added_to_cart { background-color:" . esc_attr($accent_color) . ";}"."\n";

			$custom .= ".woocommerce-notice--success:after { background-color:" . esc_attr($accent_color) . "!important;}"."\n";

			$custom .= ".woocommerce-pagination ul li span.current, .woocommerce-pagination ul li a:hover, .products li:hover .inner, .woocommerce textarea:focus, .woocommerce input:focus { border-color:" . esc_attr($accent_color) . ";}"."\n";
			//rgba
			$accent_color_rgba = themesflat_hex2rgba($accent_color, 0.2);
			$custom .= ".woocommerce-page .shop_table.cart .product-remove a, .widget_shopping_cart_content ul li a.remove { background:" . esc_attr($accent_color_rgba) . ";}"."\n";

			$custom .= " footer .widget.widget_meta ul li>a:hover:after { color:" . esc_attr($accent_color) . ";}"."\n";
