...
function themesflat_setup() {
     ...
     * to change 'graingrow' to the name of your theme in all the template files
     */
    load_theme_textdomain( 'graingrow', THEMESFLAT_DIR . '/languages' );
    ...
    register_nav_menus( array(
        'primary' => esc_html__( 'Primary Menu', 'graingrow' ),
        'bottom' => esc_html__( 'Bottom Menu', 'graingrow' )
    ) );
...
function themesflat_widgets_init() {
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Blog', 'graingrow' ),
        'id'            => 'blog-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Blog Sidebar.', 'graingrow' ),
    ...
    //Widget footer
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 1', 'graingrow' ),
        'id'            => 'footer-1',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 1.', 'graingrow' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 2', 'graingrow' ),
        'id'            => 'footer-2',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 2.', 'graingrow' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 3', 'graingrow' ),
        'id'            => 'footer-3',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer area 3.', 'graingrow' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Footer Widget Area 4', 'graingrow' ),
        'id'            => 'footer-4',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar Footer widget area 4.', 'graingrow' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Toggler', 'graingrow' ),
        'id'            => 'aside-toggler-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar toggler.', 'graingrow' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
        'before_title'  => '<h4 class="widget-title">',
        'after_title'   => '</h4>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Sidebar Shop', 'graingrow' ),
        'id'            => 'shop-sidebar',
        'description'   => esc_html__( 'Add widgets here to appear in your sidebar toggler.', 'graingrow' ),
        'before_widget' => '<div id="%1$s" class="widget %2$s">',
        'after_widget'  => '</div>',
    ...
    register_sidebar( array(
        'name'          => esc_html__( 'Services Sidebar', 'graingrow' ),
...
function themesflat_scripts() {    
    // Theme stylesheet.    
    wp_enqueue_style( 'icon-graingrow', THEMESFLAT_LINK . 'css/icon-graingrow.css' );
    wp_enqueue_style( 'farm-icon-extend', THEMESFLAT_LINK . 'css/icon-farm.css' );
