                        ...
                        <main id="main" class="main-content" role="main"> 
                            <?php
                                ...
                                if ( $show_filter == 1 ) {  
                                    ...
                                    echo '<ul class="services-filter posttype-filter"><li class="active"><a data-filter="*" href="#">' . esc_html__( 'All', 'graingrow' ) . '</a></li>'; 
                                            ...
                                            <div class="services-post services-post-<?php the_ID(); ?>">
                                                ...
                                                <div class="content"> 
                                                    ...
                                                    <div class="tf-button-container">
                                                        <a href="<?php echo esc_url( get_permalink() ); ?>" class="tf-button bt_icon_after"><?php esc_html_e('Read More', 'graingrow') ?> <i class="fas fa-arrow-right"></i></a>
                                                    </div>
