...
<div class="<?php echo esc_attr($classes); ?>">
    ...
    <div class="wrap-portfolios-post row <?php echo esc_attr($settings['columns']); ?> <?php echo esc_attr($show_filter_class); ?> <?php echo esc_attr( $settings['style_arrow'] ); ?>">
                        ...
                        <div class="inner-content">
                            ...
                            <div class="tf-button-pj2">
                                <a href="<?php echo esc_url( get_permalink() ) ?>" class="tf-button">
                                    <?php echo \Elementor\Addon_Elementor_Icon_manager_graingrow::render_icon( $settings['post_icon_readmore2'], [ 'aria-hidden' => 'true' ] );?>
                                </a>
                            </div> 
                        </div>                                              
                    </div>
