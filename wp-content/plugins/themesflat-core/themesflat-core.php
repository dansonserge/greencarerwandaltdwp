...
$theme = wp_get_theme();
if ( 'graingrow' == $theme->name || 'graingrow' == $theme->parent_theme ) {
...
final class ThemesFlat_Addon_For_Elementor_graingrow {
    ...
    public function widget_scripts() {
        ...
        wp_register_script( 'tf-svg', plugins_url( '/assets/js/svg/tf-svg.js', __FILE__ ), [ 'jquery' ], false, true );
    }
    ...
    ========================================= */
        ...
        public static function get_template_id( $type ) {
            ...
            $tfhf_templates = ThemesFlat_Addon_For_Elementor_graingrow::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
    ...
    ======================================== */
        ...
        public static function get_location_selections() {
            ...
            if ( class_exists( 'WooCommerce' ) ) {
                $special_pages['special-woo-shop'] = esc_html__( 'WooCommerce Shop Page', 'themesflat-core' );
            }
...
ThemesFlat_Addon_For_Elementor_graingrow::instance();