...
class TFCountdown_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Countdown', 'themesflat-core' );
    }
	...
	protected function register_controls() {
		// Start Countdown        
			...
			$this->add_control(
				'due_date',
				[
					'label' => esc_html__( 'Due Date', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::DATE_TIME,
					'default' => gmdate( 'Y-m-d H:i', strtotime( '+1 month' ) + ( get_option( 'gmt_offset' ) * HOUR_IN_SECONDS ) ),
					'description' => sprintf( esc_html__( 'Date set according to your timezone: %s.', 'themesflat-core' ), \Elementor\Utils::get_timezone_string() ),
				]
			);
			...
			$this->add_control(
				'show_days',
				[
					'label' => esc_html__( 'Days', 'themesflat-core' ),
			...
			$this->add_control(
				'show_hours',
				[
					'label' => esc_html__( 'Hours', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'themesflat-core' ),
					'label_off' => esc_html__( 'Hide', 'themesflat-core' ),
					'default' => 'yes',
			...
			$this->add_control(
				'show_minutes',
				[
					'label' => esc_html__( 'Minutes', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'themesflat-core' ),
					'label_off' => esc_html__( 'Hide', 'themesflat-core' ),
					'default' => 'yes',
			...
			$this->add_control(
				'show_seconds',
				[
					'label' => esc_html__( 'Seconds', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'themesflat-core' ),
					'label_off' => esc_html__( 'Hide', 'themesflat-core' ),
					'default' => 'yes',
			...
			$this->add_control(
				'show_labels',
				[
					'label' => esc_html__( 'Show Label', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'label_on' => esc_html__( 'Show', 'themesflat-core' ),
					'label_off' => esc_html__( 'Hide', 'themesflat-core' ),
					'default' => 'yes',
			...
			$this->add_control(
				'custom_labels',
				[
					'label' => esc_html__( 'Custom Label', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SWITCHER,
					'condition' => [
						'show_labels!' => '',
					],
			...
			$this->add_control(
				...
				[
					...
					'default' => esc_html__( 'Days', 'themesflat-core' ),
					'placeholder' => esc_html__( 'Days', 'themesflat-core' ),
					'condition' => [
						'show_labels!' => '',
						'custom_labels!' => '',
						'show_days' => 'yes',
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Hours', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Hours', 'themesflat-core' ),
					'placeholder' => esc_html__( 'Hours', 'themesflat-core' ),
					'condition' => [
						'show_labels!' => '',
						'custom_labels!' => '',
						'show_hours' => 'yes',
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Minutes', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Minutes', 'themesflat-core' ),
					'placeholder' => esc_html__( 'Minutes', 'themesflat-core' ),
					'condition' => [
						'show_labels!' => '',
						'custom_labels!' => '',
						'show_minutes' => 'yes',
			...
			$this->add_control(
				...
				[
					'label' => esc_html__( 'Seconds', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::TEXT,
					'default' => esc_html__( 'Seconds', 'themesflat-core' ),
					'placeholder' => esc_html__( 'Seconds', 'themesflat-core' ),
					'condition' => [
						'show_labels!' => '',
						'custom_labels!' => '',
						'show_seconds' => 'yes',
		...
		// Start Boxes
	        $this->start_controls_section(
				'section_box_style',
				[
					'label' => esc_html__( 'Boxes', 'themesflat-core' ),
			...
			$this->add_responsive_control(
				'container_width',
				[
					'label' => esc_html__( 'Container Width', 'themesflat-core' ),
			...
			$this->add_responsive_control(
				'container_height',
				[
					'label' => esc_html__( 'Padding Top & Bottom', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'default' => [
						'unit' => 'px',
						'size' => 20,
		...
		// Start Content
			...
			$this->add_control(
				'label_display',
				[
					'label' => esc_html__( 'View', 'themesflat-core' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'options' => [
						'view-block' => esc_html__( 'Block', 'themesflat-core' ),
						'view-inline' => esc_html__( 'Inline', 'themesflat-core' ),
					],
					'default' => 'view-block',
				]
			);
			...
			$this->add_control(
				'heading_digits',
				[
					'label' => esc_html__( 'Digits', 'themesflat-core' ),
	...
	private function init_default_countdown_labels() {
		$this->_default_countdown_labels = [
			'label_months' => esc_html__( 'Months', 'themesflat-core' ),
			'label_weeks' => esc_html__( 'Weeks', 'themesflat-core' ),
			'label_days' => esc_html__( 'Days', 'themesflat-core' ),
			'label_hours' => esc_html__( 'Hours', 'themesflat-core' ),
			'label_minutes' => esc_html__( 'Minutes', 'themesflat-core' ),
			'label_seconds' => esc_html__( 'Seconds', 'themesflat-core' ),
		];
	}
