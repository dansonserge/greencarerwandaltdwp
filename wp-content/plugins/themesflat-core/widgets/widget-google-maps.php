...
class TF_Google_Maps_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TF Google Maps', 'themesflat-core' );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_map',
			[
				'label' => esc_html__( 'Map', 'themesflat-core' ),
			]
		);
				...
				$this->add_control(
					...
					[
						...
						'raw' => sprintf(
							...
							esc_html__( 'Set your Google Maps API Key in Elementor\'s <a href="%1$s" target="_blank">Integrations Settings</a> page. Create your key <a href="%2$s" target="_blank">here.', 'themesflat-core' ),
		...
		$default_address = esc_html__( '90 Stanmer St, London SW11 3DE, UK', 'themesflat-core' );
		$this->add_control(
			'address',
			[
				'label' => esc_html__( 'Location', 'themesflat-core' ),
		...
		$this->add_control(
			'zoom',
			[
				'label' => esc_html__( 'Zoom', 'themesflat-core' ),
		...
		$this->add_control(
			'hover_transition',
			[
				'label' => esc_html__( 'Transition Duration', 'themesflat-core' ),
				'type' => \Elementor\Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 3,
