...
class TFRainDrop_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Rain Drop', 'themesflat-core' );
    }
	...
	protected function register_controls() {
		// Start Tab Setting        
			$this->start_controls_section( 'section_raindrop',
	            [
	                'label' => esc_html__('Rain Drop', 'themesflat-core'),
	            ]
	        );
	        $this->add_responsive_control(
	            'line_rain_drop_width',
	            [
	                'label' => esc_html__( 'Width', 'graingrow' ),
	        ...
	        $this->add_responsive_control(
	            ...
	            [
	                'label' => esc_html__( 'Height', 'graingrow' ),
	                'type' => \Elementor\Controls_Manager::SLIDER,
	                'size_units' => [ 'px', '%' ],
	                'range' => [
	                    'px' => [
	        ...
	        $this->add_control(
	            ...
	            [
	                'label' => esc_html__( 'Line Color', 'graingrow' ),
	        ...
	        $this->add_control(
	            'rain_drop_color',
	            [
	                'label' => esc_html__( 'Rain Drop Color', 'graingrow' ),
	                'type' => \Elementor\Controls_Manager::COLOR,
	                'default' => '#000000',
	                'selectors' => [
