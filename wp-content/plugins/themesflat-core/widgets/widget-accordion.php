...
class TFAccordion_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'TF Accordion', 'graingrow' );
    }
	...
	protected function _register_controls() {
        // Start Accordion        
			$this->start_controls_section( 
				'section_accordion',
	            [
	                'label' => esc_html__('Accordion', 'graingrow'),
	            ]
	        );	

	    	$this->add_control( 'heading_icon',
				[
					'label' => esc_html__( 'Icon', 'graingrow' ),
			...
			$this->add_control( 'icon_style',
				[
					'label' => esc_html__( 'Icon Style', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::CHOOSE,
					'options' => [
						'none' => [
							'title' => esc_html__( 'None', 'graingrow' ),
							'icon' => 'fa fa-ban',
						],
						'icon' => [
							'title' => esc_html__( 'Icon', 'graingrow' ),
							'icon' => 'eicon-favorite',
						],
						'image' => [
							'title' => esc_html__( 'Image', 'graingrow' ),
							'icon' => 'eicon-image',
						],
					],
					'default' => 'icon',
			...
			$this->add_control( 
				'icon_position',
				[
					'label' => esc_html__( 'Icon Position', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => 'icon_after',
					'options' => [
						'icon_before'  => esc_html__( 'Left', 'graingrow' ),
						'icon_after' => esc_html__( 'Right', 'graingrow' ),
						'icon_before_after' => esc_html__( 'Both side', 'graingrow' ),
					],
					'condition' => [
						'icon_style!' => 'none',
					],
			...
			$this->add_control( 'icon_accodion',
				[
					'label' => esc_html__( 'Left Icon', 'graingrow' ),
			...
			$this->add_control( 'image_accodion',
				[
					'label' => esc_html__( 'Left Icon Image', 'graingrow' ),
			...
			$this->add_control( 'icon_accodion_active',
				[
					'label' => esc_html__( 'Left Icon Active', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_active',
				[
					'label' => esc_html__( 'Left Icon Image Active', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
			...
			$this->add_control( 'icon_accodion_right',
				[
					'label' => esc_html__( 'Right Icon', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_right',
				[
					'label' => esc_html__( 'Right Icon Image', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
			...
			$this->add_control( 'icon_accodion_right_active',
				[
					'label' => esc_html__( 'Right Icon Active', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::ICONS,
			...
			$this->add_control( 'image_accodion_right_active',
				[
					'label' => esc_html__( 'Right Icon Image Active', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::MEDIA,
					'default' => [
						'url' => \Elementor\Utils::get_placeholder_image_src(),
					],
	        ...
	        $repeater = new \Elementor\Repeater();
	        	$repeater->add_control( 'set_active',
					[
						'label' => esc_html__( 'Set Active Item', 'graingrow' ),
						'type' => \Elementor\Controls_Manager::SWITCHER,
						'label_on' => esc_html__( 'Yes', 'graingrow' ),
						'label_off' => esc_html__( 'No', 'graingrow' ),
						'return_value' => 'active',
						'default' => 'inactive',
					]
				);		        
		        $repeater->add_control( 'list_title', [
						'label' => esc_html__( 'Nav text', 'graingrow' ),
						'type' => \Elementor\Controls_Manager::TEXT,
						'default' => esc_html__( 'Accordion' , 'graingrow' ),
						'label_block' => true,
					]
				);
				$repeater->add_control( 'heading_content',
					[
						'label' => esc_html__( 'Content', 'graingrow' ),
						'type' => \Elementor\Controls_Manager::HEADING,
						'separator' => 'before',
					]
				);
				$repeater->add_control( 'list_content_text_type',
					[
						'label' => esc_html__( 'Content type', 'graingrow' ),
						'type' => \Elementor\Controls_Manager::SELECT,
						'default' => 'editor',
						'options' => [
							'editor'  => esc_html__( 'Editor', 'graingrow' ),
							'template' => esc_html__( 'Template', 'graingrow' ),
						],
					]
				);	
				$repeater->add_control( 'list_content', [
						'label' => esc_html__( 'Content text', 'graingrow' ),
						'type' => \Elementor\Controls_Manager::WYSIWYG,
						'default' => esc_html__( 'Good strategy is the antidote to competition. Strategic thinking is the process of developing a strategy that defines your value proposition and your unique value chain. This process includes market and competitive research as well as an assessment of the company’s capabilities and the industry forces impacting it.' , 'graingrow' ),
						'label_block' => true,
						'condition' => [
				...
				$repeater->add_control( 'list_content_template',
					[
						'label' => esc_html__( 'Choose Template', 'graingrow' ),
						'type' => \Elementor\Controls_Manager::SELECT,
		        ...
		        $this->add_control( 'accordion_list',
					[					
						...
						'default' => [
							[	
								'set_active' => 'active',
								'list_title' => esc_html__( '01. What does you do?', 'graingrow' ),
							...
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '02. What is graphics design?', 'graingrow' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '03. Why we are the best?', 'graingrow' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '04. What is industries covered?', 'graingrow' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
							[
								'set_active' => 'inactive',
								'list_title' => esc_html__( '05. What is graphics design?', 'graingrow' ),
								'list_content' => esc_html__( "Lorem Ipsum is simply dummy of free available in market the printing and typesetting industry has been industry's standard." ),
							],
						],
		...
		// Start General Style 
	        $this->start_controls_section( 
	            ...
	            [
	                'label' => esc_html__( 'General', 'graingrow' ),
	         ...
	         $this->add_control(
				'wrap_align',
				[
					'label' => esc_html__( 'Alignment', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::CHOOSE,
					'options' => [
						'left'    => [
							'title' => esc_html__( 'Left', 'graingrow' ),
							'icon' => 'eicon-text-align-left',
						],
						'center' => [
							'title' => esc_html__( 'Center', 'graingrow' ),
							'icon' => 'eicon-text-align-center',
						],
						'right' => [
							'title' => esc_html__( 'Right', 'graingrow' ),
							'icon' => 'eicon-text-align-right',
						],
						'justify' => [
							'title' => esc_html__( 'Justified', 'graingrow' ),
	    ...
	    // Start Item Style 
	        $this->start_controls_section( 
	        	'section_style_item',
	            [
	                'label' => esc_html__( 'Item', 'graingrow' ),
	                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
	            ]
	        );
			...
			$this->add_group_control(
				...
				[
					'name' => 'item_box_shadow1',
					'label' => esc_html__( 'Box Shadow', 'graingrow' ),
			...
			$this->add_control( 
				'item_border_radius',
				[
					'label' => esc_html__( 'Border Radius', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::DIMENSIONS,
					'size_units' => [ 'px' , 'em' , '%' ],
					'selectors' => [
        ...
        // Start Icon Style 
	        ...
	        $this->add_responsive_control(
				'icon_size_w',
				[
					'label' => esc_html__( 'Icon Size Width', 'graingrow' ),
			...
			$this->add_responsive_control(
				'icon_size_h',
				[
					'label' => esc_html__( 'Icon Size Height', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px', '%' ],
					'range' => [
						'px' => [
	        ...
	        $this->add_control(
				'heading_icon_left',
				[
					'label' => esc_html__( 'Icon Left', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'icon_position' => ['icon_before', 'icon_before_after'],
			...
			$this->add_responsive_control(
				'icon_font_size',
				[
					'label' => esc_html__( 'Icon Font Size', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::SLIDER,
					'size_units' => [ 'px' ],
					'range' => [
						'px' => [
			...
			$this->start_controls_tabs( 
	        	...
	        	$this->start_controls_tab( 
					...
					[
						'label' => esc_html__( 'Normal', 'graingrow' ),
					] );	
				...
				$this->start_controls_tab( 
					...
					[
						'label' => esc_html__( 'Active', 'graingrow' ),
					] );
			...
			$this->add_control(
				'heading_icon_right',
				[
					'label' => esc_html__( 'Icon Right', 'graingrow' ),
					'type' => \Elementor\Controls_Manager::HEADING,
					'separator' => 'before',
					'condition' => [
	                    'icon_position' => ['icon_after', 'icon_before_after'],
	    ...
	    // Start Title Style 
	        $this->start_controls_section( 
	        	'section_style_title',
	            [
	                'label' => esc_html__( 'Title', 'graingrow' ),
	                'tab' => \Elementor\Controls_Manager::TAB_STYLE,
	            ]
	        );
		...
		foreach ($settings['accordion_list'] as $key => $value) {
			...
			if ( $settings['icon_style'] == 'icon' ) {
				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_close =  \Elementor\Addon_Elementor_Icon_manager_graingrow::render_icon( $settings['icon_accodion'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_close =  \Elementor\Addon_Elementor_Icon_manager_graingrow::render_icon( $settings['icon_accodion_right'] );
				}

				if ( $settings['icon_position'] == 'icon_before' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_open =  \Elementor\Addon_Elementor_Icon_manager_graingrow::render_icon( $settings['icon_accodion_active'] );
				}
				if ( $settings['icon_position'] == 'icon_after' || $settings['icon_position'] == 'icon_before_after' ) {
					$icon_accodion_right_open =  \Elementor\Addon_Elementor_Icon_manager_graingrow::render_icon( $settings['icon_accodion_right_active'] );
				}
