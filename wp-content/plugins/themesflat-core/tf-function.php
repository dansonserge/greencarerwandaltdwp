...
if(!function_exists('tf_header_enabled')){
    function tf_header_enabled() {
        $header_id = ThemesFlat_Addon_For_Elementor_graingrow::get_settings( 'type_header', '' );
        $status    = false;
...
if(!function_exists('tf_footer_enabled')){
    function tf_footer_enabled() {
        $header_id = ThemesFlat_Addon_For_Elementor_graingrow::get_settings( 'type_footer', '' );
        $status    = false;
...
if(!function_exists('get_header_content')){
    function get_header_content() {
        $tf_get_header_id = ThemesFlat_Addon_For_Elementor_graingrow::tf_get_header_id();
